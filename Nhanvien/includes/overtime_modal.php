    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">NgàyNgày</label>
                ...
                <div class="form-group">
                  	<label for="hours" class="col-sm-3 control-label">Số giờ làm</label>
                ...
                <div class="form-group">
                  	<label for="mins" class="col-sm-3 control-label">Số phút làm</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="hours_edit" class="col-sm-3 control-label">Số giờ làm</label>
                ...
                <div class="form-group">
                    <label for="mins_edit" class="col-sm-3 control-label">Số phút làm</label>
