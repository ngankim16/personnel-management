    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Thêm ca làm</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="attendance_add.php">
          		  <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Nhân viên ID</label>
                ...
                <div class="form-group">
                  	<label for="time_in" class="col-sm-3 control-label">Bắt đầu ca</label>
                ...
                <div class="form-group">
                  	<label for="time_out" class="col-sm-3 control-label">Kết thúc ca</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                  	<label for="edit_time_in" class="col-sm-3 control-label">Bắt đầu ca</label>
                ...
                <div class="form-group">
                  	<label for="edit_time_out" class="col-sm-3 control-label">Kết thúc ca</label>
