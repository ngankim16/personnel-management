    ...
    <div class="modal-dialog">
        <div class="modal-content">
              ...
              <div class="form-group">
                  	<label for="employee_id" class="col-sm-3 control-label">Mã NV</label>
                ...
                <div class="form-group">
                    <label for="schedule" class="col-sm-3 control-label">Lịch làm</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_schedule" class="col-sm-3 control-label">Lịch làm</label>
